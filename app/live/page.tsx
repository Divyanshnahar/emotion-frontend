        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col gap-6">
            <EmotionDetector
              ...
              autoStartLive={false}
              onStream={(stream) => {
                const rightVideo = document.getElementById('live-feed-video') as HTMLVideoElement | null
                if (rightVideo) {
                  rightVideo.srcObject = stream || null
                }
              }}
            />
          </div>
...
// Removed mirror component; stream now injected directly via onStream callback.
